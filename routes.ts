...
export async function appRoutes(app: FastifyInstance) {
    ...
    app.get('/day', async (request) =>{
        ...
        //hábitos possiveis ou que já foram completados.
    ...
    //completar / desmarcar hábito feito.
    ...
    app.get('/summary', async () => {
        ...
        //Prisma ORM: RAW SQL => SQLite (somente o SQL irá interpretar o RAW, pois cada banco escrito a mão tem uma sintaxe diferente)
